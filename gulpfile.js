...
gulp.task('pug',function() {
 return gulp.src(config.src+'/assets/templates/*.pug')
 .pipe(pug({
    doctype: 'html',
    pretty: true
 }))
...
gulp.task('watch', function() {
  ...
  gulp.watch(config.src+'/assets/templates/*.pug', ['pug']);
...
gulp.task('default', [ 'watch', 'pug', 'minify', 'inline-svg', 'scss', 'js', 'media' ]);
